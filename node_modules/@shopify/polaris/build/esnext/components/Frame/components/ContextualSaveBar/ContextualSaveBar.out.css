.Polaris-Frame-ContextualSaveBar_14m7v{
...
.Polaris-Frame-ContextualSaveBar_14m7v .Polaris-Frame-ContextualSaveBar__LogoContainer_szav1{
    border-right:none;
  }

.Polaris-Frame-ContextualSaveBar_14m7v .Polaris-Frame-ContextualSaveBar__ContextControl_3di0f{
    opacity:0.3;
    pointer-events:none;
  }
...
.Polaris-Frame-ContextualSaveBar__LogoContainer_szav1{
  display:none;
}
...
.Polaris-Frame-ContextualSaveBar__Contents_1u1wn{
  display:flex;
  flex:1 1 auto;
  align-items:center;
...
.Polaris-Frame-ContextualSaveBar--fullWidth_zyvh4{
  max-width:none;
  padding:0 var(--p-space-400);
}

.Polaris-Frame-ContextualSaveBar__MessageContainer_kexmj{
  display:flex;
  flex-direction:row;
  gap:var(--p-space-200);
  overflow:hidden;
...
.Polaris-Frame-ContextualSaveBar__MessageContainer_kexmj [class*='Polaris-Icon__Svg']{
    fill:var(--p-color-text-inverse);
  }

.Polaris-Frame-ContextualSaveBar__MessageContainer_kexmj [class*='Polaris-Icon']{
    flex-shrink:0;
  }

.Polaris-Frame-ContextualSaveBar__ActionContainer_hk0rr{
  flex-shrink:0;
}

.Polaris-Frame-ContextualSaveBar__ActionContainer_hk0rr [class*='Polaris-Button--variantPrimary'],
  .Polaris-Frame-ContextualSaveBar__ActionContainer_hk0rr [class*='Button-variantPrimary']{
...
.Polaris-Frame-ContextualSaveBar__ActionContainer_hk0rr [class*='Polaris-Button--variantTertiary'],
  .Polaris-Frame-ContextualSaveBar__ActionContainer_hk0rr [class*='Button-variantTertiary']{
...
.Polaris-Frame-ContextualSaveBar__Action_r96cs{
  margin-left:var(--p-space-200);
}

.Polaris-Frame-ContextualSaveBar__ContextControl_3di0f{
  display:none;
}
