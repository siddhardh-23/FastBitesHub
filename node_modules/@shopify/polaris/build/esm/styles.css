...
.Polaris-LegacyCard h2,
  .Polaris-LegacyCard h3{
    font-size:var(--p-font-size-325);
  }
...
.Polaris-Filters__ClearAll span{
    font-size:var(--p-font-size-300);
    font-weight:var(--p-font-weight-medium);
  }
...
.Polaris-SortButton-DirectionButton__Label{
  flex:1 1;
  color:var(--p-color-text);
  margin-left:var(--p-space-050);
  font-size:var(--p-font-size-300);
...
.Polaris-IndexTable__Table--sticky .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell{
      position:sticky;
      z-index:var(--pc-index-table-sticky-cell);
  }
    }
...
.Polaris-IndexTable__Table--sticky .Polaris-IndexTable__TableHeading--second:not(.Polaris-IndexTable__TableHeading--unselectable){
        position:sticky;
        left:0;
        z-index:var(--pc-index-table-sticky-cell);
    }
...
.Polaris-IndexTable__Table--sticky .Polaris-IndexTable__TableHeading--second.Polaris-IndexTable__TableHeading--unselectable{
      position:sticky;
      left:0;
      z-index:var(--pc-index-table-sticky-cell);
    }
...
.Polaris-Tag{
  --pc-tag-height:1.25rem;
  position:relative;
  display:inline-flex;
  max-width:100%;
  align-items:center;
  min-height:var(--pc-tag-height);
  padding:0;
...
.Polaris-MediaCard__Description{
  font-size:var(--p-font-size-300);
  line-height:var(--p-font-line-height-400);
}
...
.Polaris-Navigation--itemChildActive .Polaris-Navigation__Text{
    font-weight:var(--p-font-weight-medium);
  }
...
.Polaris-Navigation__SecondaryNavigation .Polaris-Navigation__Item{
    font-size:0.9375rem;
    font-weight:var(--p-font-weight-regular);
    line-height:var(--pc-navigation-item-line-height);
    color:var(--p-color-text-secondary);
    position:relative;
...
.Polaris-Navigation__SecondaryNavigation .Polaris-Navigation__Item:hover .Polaris-Navigation__Text{
        font-weight:var(--p-font-weight-medium);
        letter-spacing:var(--pc-navigation-letter-spacing-medium);
      }
...
.Polaris-Navigation__SecondaryNavigation .Polaris-Navigation__Item--selected .Polaris-Navigation__Text{
...
.Polaris-TopBar-UserMenu__Message > p{
  color:var(--p-color-text-inverse-secondary);
  font-size:var(--p-font-size-275);
  line-height:var(--p-font-line-height-300);
}
